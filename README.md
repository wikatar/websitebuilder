...
## Template Usage
This website uses the business template from the WebsiteBuilder core system:
- Template: `business v1.0.0`
- Framework: Tailwind + DaisyUI
- Features: Multi-language, SEO optimization, Analytics

## Development

### Prerequisites
- Access to WebsiteBuilder core system
- Node.js 18+
- Python 3.8+
...
3. Copy required template files from WebsiteBuilder core
...
- SEO settings: `config/seo/config.json`
- Nginx configuration: `config/nginx/`

## Maintenance
- Regular backups are stored in `backup/`
- Logs are available in `logs/`
- SSL certificates are managed in `ssl/`
